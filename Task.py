...
def run():
    st.set_page_config(
        page_title="Cryptoarithmetic function",
...
expression = st.text_input('enter a cryptoarythmetic puzzle (like "two + two = four")')

if expression:
    with st.spinner("Trying to find a solution for your puzzle..."):
        ...
        # als de vorige 2 exceptions niet voorkomen kan de puzzel berekend worden
            ...
            if output:
                ...
                st.success('Good news! A possible solution for your puzzle has been found:', icon="✅")
                ...
                st.error('Bad news! No possible solution has been found for your puzzle.', icon="🚨")